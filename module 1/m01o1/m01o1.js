...
if (gewenste_aantal_autos <= 80){
    ...
    antwoord = Math.ceil((gewenste_aantal_autos - 80) / 120)
}

document.getElementById("antwoord").innerText = ("Om het gewenste aantal autos kwijt te kunnen heb ik " + antwoord + " verdiepingen nodig.");

console.log("Om het gewenste aantal autos kwijt te kunnen heb ik " + antwoord + " verdiepingen nodig.")
alert("Om het gewenste aantal autos kwijt te kunnen heb ik " + antwoord + " verdiepingen nodig.");